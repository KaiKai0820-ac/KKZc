...
- Cookie 包含你的账号登录凭证，请妥善保管，不要泄露给他人
- 建议合理设置线程数和速率限制，避免请求过于频繁导致账号受限
- `done_urls.txt` 记录了已完成的链接，删除该文件会导致重复转存
- 夸克网盘接口可能随时变更，如遇到转存失败请检查是否需要更新

## 免责声明

本项目仅供学习和个人使用，请勿用于任何商业或非法用途。使用本工具时请遵守以下条款：

1. 用户应遵守夸克网盘的服务条款及相关法律法规
2. 本工具不提供任何资源内容，仅实现网盘文件的转存功能
3. 用户对其转存的内容负全部责任，与本项目开发者无关
4. 因使用本工具导致的账号封禁、数据丢失等后果，开发者不承担任何责任
5. 本项目不保证长期可用性，夸克网盘接口变更可能导致功能失效
